      ...
      <Container>
        ...
        <div ref={ref} className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-32 relative z-10">
          {[
            ...
            >
              <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-gold-500/20 to-gold-500/5 flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-500 border border-gold-500/10">
        ...
        <div className="space-y-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <span className="text-gold-400 text-sm font-medium tracking-wider uppercase mb-4 block">Residential Solutions</span>
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-white mb-6">
                Transform Your Home<br />Into a Power Plant
              </h2>
              <p className="text-lg text-white/70 mb-8 leading-relaxed">
                Slash your electricity bills and increase your property value with our aesthetically designed solar systems. We handle everything from permits to activation.
              </p>
              <ul className="space-y-4 mb-8">
                {['Zero-down financing options', 'Smart monitoring app included', 'Backup battery integration'].map((item, i) => (
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="relative aspect-square lg:aspect-[4/3] rounded-3xl overflow-hidden order-1 lg:order-2 group bg-midnight-900 border border-white/5"
            >
              {/* Fallback pattern since we can't generate more images */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.8 }}
              className="relative aspect-square lg:aspect-[4/3] rounded-3xl overflow-hidden group bg-midnight-900 border border-white/5"
            >
            ...
            >
              <span className="text-gold-400 text-sm font-medium tracking-wider uppercase mb-4 block">Commercial Solutions</span>
              <h2 className="text-4xl md:text-5xl font-heading font-bold text-white mb-6">
              ...
              <p className="text-lg text-white/70 mb-8 leading-relaxed">
               ...
               <ul className="space-y-4 mb-8">
                {['Tax incentives & depreciation', 'Scalable megawatt systems', 'O&M packages available'].map((item, i) => (
                  <li key={i} className="flex items-center gap-3 text-white/80">
                    <div className="w-1.5 h-1.5 rounded-full bg-gold-400" />
                    {item}
                  </li>
