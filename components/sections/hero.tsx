...
export function Hero() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      ...
      // 2. Overlay gradient sweep (Sun ray effect)
      ...
      // Safely check for children before animating
      ...
      // 4. Parallax Effect (Smoother/Subtle)
  ...
  return (
    <section ref={containerRef} className="relative h-[100dvh] min-h-[700px] w-full overflow-hidden bg-midnight-950 flex items-center">
      {/* Background Image with Parallax */}
      <div ref={imageRef} className="absolute inset-0 w-full h-full z-0 pointer-events-none will-change-transform">
        <Image
          src="/hero-solar.png"
      ...
      <Container className="relative z-10 pt-20">
        <div ref={textRef} className="max-w-4xl">
          ...
          <p className="text-lg md:text-2xl text-white/80 max-w-2xl mb-10 leading-relaxed font-light mix-blend-plus-lighter">
            Engineered for aesthetics, designed for performance. Experience the ultimate energy independence with our premium solar solutions.
          </p>
          
          <div className="flex flex-col sm:flex-row gap-5">
            <Button size="lg" className="text-lg px-8 py-6 shadow-[0_0_30px_rgba(251,191,36,0.2)] hover:shadow-[0_0_40px_rgba(251,191,36,0.5)] transition-all duration-500">
              Get Your Custom Proposal
            </Button>
            <Button variant="secondary" size="lg" className="text-lg px-8 py-6 backdrop-blur-md bg-white/5 hover:bg-white/10 border-white/20 group">
              View Our Work 
