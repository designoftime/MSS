              ...
              {team.map((member, i) => (
                <div key={i} className="group text-center">
                  <div className="relative aspect-[3/4] rounded-2xl overflow-hidden mb-6 border border-white/10 mx-auto max-w-sm bg-midnight-900">
                    ...
                    {/* Optional subtle hover overlay (fully transparent by default) */}
                    <div className={`absolute inset-0 bg-gradient-to-br opacity-0 group-hover:opacity-20 transition-opacity duration-500 ${
                      i === 0 ? "from-gold-900/30 via-midnight-900 to-midnight-800" :
                      i === 1 ? "from-blue-900/30 via-midnight-900 to-midnight-800" :
                      "from-purple-900/30 via-midnight-900 to-midnight-800"
                    }`} />

                    {/* Optional SVG hover effect */}
                    <div className="absolute inset-0 flex items-center justify-center opacity-0 group-hover:opacity-20 transition-all duration-500 group-hover:scale-105">
